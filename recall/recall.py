...
if __name__ == '__main__':
    if mode == 'valid':
        ...
        recall_path = os.path.join(root_dir, 'user_data', 'data', 'offline')
    else:
        ...
        recall_path = os.path.join(root_dir, 'user_data', 'data', 'online')
    ...
    for recall_method in recall_methods:
        recall_result = pd.read_pickle(
            os.path.join(recall_path, f'recall_{recall_method}.pkl'))
    ...
    if mode == 'valid':
        ...
        df_useful_recall.to_pickle(os.path.join(output_dir, 'recall.pkl'))
    else:
