...
def recall(df_query, item_sim, user_item_dict, worker_id):
    ...
    tmp_dir = os.path.join(root_dir, 'user_data', 'tmp', 'binetwork')
    os.makedirs(tmp_dir, exist_ok=True)
    df_data.to_pickle(os.path.join(tmp_dir, f'{worker_id}.pkl'))
...
if __name__ == '__main__':
    if mode == 'valid':
        ...
        sim_dir = os.path.join(root_dir, 'user_data', 'sim', 'offline')
        os.makedirs(sim_dir, exist_ok=True)
        sim_pkl_file = os.path.join(sim_dir, 'binetwork_sim.pkl')
    else:
        ...
        sim_dir = os.path.join(root_dir, 'user_data', 'sim', 'online')
        os.makedirs(sim_dir, exist_ok=True)
        sim_pkl_file = os.path.join(sim_dir, 'binetwork_sim.pkl')
    ...
    if mode == 'valid':
        ...
        df_data.to_pickle(os.path.join(output_dir, 'recall_binetwork.pkl'))
    else:
