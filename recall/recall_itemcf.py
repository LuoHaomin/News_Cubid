...
def recall(df_query, item_sim, user_item_dict, worker_id):
    ...
    tmp_dir = os.path.join(root_dir, 'user_data', 'tmp', 'itemcf')
...
if __name__ == '__main__':
    if mode == 'valid':
        ...
        sim_pkl_file = os.path.join(sim_dir, 'itemcf_sim.pkl')
    else:
    ...
    if mode == 'valid':
        ...
        df_data.to_pickle(os.path.join(output_dir, 'recall_itemcf.pkl'))
    else:
